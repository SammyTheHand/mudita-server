		...
		<div class="flex justify-between">
			<div>
				<ul class="flex justify-center font-nunito text-gray-700 mb-4 font-semibold leading-loose tracking-wide">
					<li><a href="promotion" class="px-5 hover:text-brand-green border-b-4 border-brand-green">Promotion</a></li>
			...
			<div>
				<a href="https://s3-eu-west-1.amazonaws.com/artificers.io/apps/mudita/promotion.mp4" class="align-middle mr-5 px-5 py-2 rounded-lg shadow-lg bg-brand-green hover:bg-teal-700 text-white font-nunito focus:outline-none focus:shadow-outline" download>Download</a>
			</div>
		</div>
		<div class="w-full">
			<video  id="video" 
					...
					controls
			>
			<source src="https://s3-eu-west-1.amazonaws.com/artificers.io/apps/mudita/promotion.mp4" type="video/mp4">
			<p class='vjs-no-js'>
