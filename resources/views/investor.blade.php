...
<body>
	...
	<main>
		<div class="flex justify-between">
			...
			<div>
				<a href="/assets/video/investor.mp4" class="align-middle mr-5 px-5 py-2 rounded-lg shadow-lg bg-brand-green hover:bg-teal-700 text-white font-nunito focus:outline-none focus:shadow-outline" download>Download</a>
			</div>
		</div>
		<div>
			<video  id="video" 
